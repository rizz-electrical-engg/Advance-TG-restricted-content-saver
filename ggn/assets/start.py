...
async def start(event):
    ...
    collection.update_one({"user_id": user_id}, {"$set": {"user_id": user_id}}, upsert=True)
    buttons = [
        [Button.url("Join Channel", url="https://t.me/+xItYyMB4-ZBjMTc1")],
...
S = "/start"
START_PIC = "https://graph.org/file/7cbc7ceaecb8ed6c3331e.gif"
...
async def term_command(event):
    ...
    buttons = [
        [Button.url("Query?", url="https://t.me/RD_C4"),
         Button.url("Channel", url="https://t.me/+xItYyMB4-ZBjMTc1")]
    ]
...
async def youtube_dl_command(_, message):
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            caption = f"{video_info['title']}\n\n__**Powered by [Advance Content Saver Bot](https://t.me/RD_C4)**__"  # Set caption to the title of the video
